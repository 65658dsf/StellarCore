...
set GOOS=windows
set GOARCH=386
go build -trimpath -ldflags "-s -w" -o "output/frpc/%BINARY_NAME%.exe" ./cmd/frpc/
upx --best --lzma "output/frpc/%BINARY_NAME%.exe"
powershell -Command "Compress-Archive -Path 'output/frpc/%BINARY_NAME%.exe' -DestinationPath 'output/frpc/%BINARY_NAME%_%VERSION%_windows_386.zip' -Force"
...
go build -trimpath -ldflags "-s -w" -o "output/frpc/%BINARY_NAME%.exe" ./cmd/frpc/
upx --best --lzma "output/frpc/%BINARY_NAME%.exe"
powershell -Command "Compress-Archive -Path 'output/frpc/%BINARY_NAME%.exe' -DestinationPath 'output/frpc/%BINARY_NAME%_%VERSION%_windows_amd64.zip' -Force"
del "output\%BINARY_NAME%.exe"
...
go build -trimpath -ldflags "-s -w" -o "output/frpc/%BINARY_NAME%.exe" ./cmd/frpc/
upx --best --lzma "output/frpc/%BINARY_NAME%.exe"
powershell -Command "Compress-Archive -Path 'output/frpc/%BINARY_NAME%.exe' -DestinationPath 'output/frpc/%BINARY_NAME%_%VERSION%_windows_arm32.zip' -Force"
del "output\%BINARY_NAME%.exe"
...
go build -trimpath -ldflags "-s -w" -o "output/frpc/%BINARY_NAME%.exe" ./cmd/frpc/
upx --best --lzma "output/frpc/%BINARY_NAME%.exe"
powershell -Command "Compress-Archive -Path 'output/frpc/%BINARY_NAME%.exe' -DestinationPath 'output/frpc/%BINARY_NAME%_%VERSION%_windows_arm64.zip' -Force"
del "output\%BINARY_NAME%.exe"
...
set GOOS=linux
set GOARCH=386
go build -trimpath -ldflags "-s -w" -o "output/frpc/%BINARY_NAME%" ./cmd/frpc/
upx --best --lzma "output/frpc/%BINARY_NAME%"
