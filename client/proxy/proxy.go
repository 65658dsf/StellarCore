...
import (
	...
	plugin "github.com/65658dsf/StellarCore/pkg/plugin/client"
...
func (pxy *BaseProxy) HandleTCPWorkConnection(workConn net.Conn, m *msg.StartWorkConn, encKey []byte) {
	...
	xl.Tracef("处理TCP工作连接, 使用加密: %t, 使用压缩: %t",
	...
	if pxy.proxyPlugin != nil {
		...
		xl.Debugf("插件处理连接: %s", pxy.proxyPlugin.Name())
	...
	if err != nil {
		workConn.Close()
		xl.Errorf("连接到本地服务 [%s:%d] 失败: %v", baseCfg.LocalIP, baseCfg.LocalPort, err)
		return
	}
